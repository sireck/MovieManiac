<html>
    <head>
        ...
        ?>        
    <title>Movie Mania - Online Movie Recommender - Your Wanna Watch List</title>
    </head>
    <body>
    ...
    <script type="text/javascript">
        $.get("<?php echo $POST.'wannawatch.php?logged_user_id='.$logged_user_id; ?>", function(data) {
            document.getElementById("wannawatch-results").innerHTML = loadWannaWatch(data);
        });
    </script>
        <div class="wannawatch">
            <p class=heading>Wanna Watch list!</p>
