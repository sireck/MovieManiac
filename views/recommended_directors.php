<html>
    ...
    <script type="text/javascript">
        ...
        $.get("<?php echo $POST.'recommended_directors.php?logged_user_id='.$logged_user_id; ?>", function(data) {
            document.getElementById("wannawatch-results").innerHTML = loadWannaWatch(data);
        });
    </script>
        <div class="wannawatch">
            <p class=heading>Recommended Movies based on favorite actors <a href='./recommended_actors'> (show by actors)</a></p>
