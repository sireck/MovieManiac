<html>
    <head>
        ...
        function get_results() {
            document.getElementById("Results").innerHTML    =   "<img class=loading src=<?php echo $IMAGES.'loading.gif' ?> width='100'>";
    ...
    <form action="" method="GET">
        <div class="homesearchbox">
            <input class="homePageSearchBox" type="text" autocomplete="off" name="search_string" value="<?php echo $search_string;?>" id="search_string"/>
